...
Paramètres JAGS :
```{r}
bugs.monitorexp = c("lambda", "sigmaProc", "N", "tauProc")
bugs.chains = 3
bugs.initsexp = function() {
  list()
}
```
...
# Prédiction en pondérant par rapport au DIC

modele exp
modele logi

boucle de 5 a 20
appliquer prédiction sur les 5 années suivantes
avec 2 modeles

calculer DIC

simuler 5 années suivantes avec modele choisi par pondération


## En utilisant les données du loup

## En utilisant des données simulées
